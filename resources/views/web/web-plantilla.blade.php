...
<body>
    <!-- Start Top Nav -->
    <nav class="navbar navbar-expand-lg bg-tinted-window navbar-light d-none d-lg-block" id="templatemo_nav_top">
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
                <div>
                    <i class="fa fa-envelope mx-2"></i>
                    <a class="navbar-sm-brand text-light text-decoration-none" href="mailto:echavarriagtomas@gmail.com">info@burgerhub.com</a>
                    <i class="fa fa-phone mx-2"></i>
                    <a class="navbar-sm-brand text-light text-decoration-none" href="tel:313-882-2679">313 882 2679</a>
                </div>
                <div>
    ...
    <!-- Header -->
    <nav class="navbar navbar-expand-lg navbar-light shadow bg-black-dark">
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        <li class="nav-item">
                            <a class="nav-link text-orange-vibrant" href="/">Inicio</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-orange-vibrant" href="takeaway">Takeaway</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-orange-vibrant" href="nosotros">Nosotros</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-orange-vibrant" href="contacto">Contacto</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="d-lg-none flex-sm-fill mt-3 mb-4 col-7 col-sm-auto pr-3">
                        <div class="input-group">
                            ...
                            <div class="input-group-text">
                                <i class="fa fa-fw fa-search text-orange-vibrant"></i>
                            </div>
                        </div>
                    </div>
...
@yield("contenido")
    ...
    <script src="web/js/templatemo.js"></script>
